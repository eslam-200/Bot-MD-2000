...
let handler = async (m, { conn, usedPrefix, command }) => {
    ...
    let videoUrl = 'https://qu.ax/kied.jpg';
...
━ ── • ⟐ • ── ━
❐┇❯ *اســم الـبــوت ❰ س ـؤنيك أإلع  ـريك ❱*
❐┇❯ *وقــت الـتشـغـيــل* : ⌊  ${uptime}  ⌉╎
❐┇❯ *الـمـطـور : ⌊https://wa.me/+201115918583╎*
❐┇❯ *الـمـطـور : ⌊س ـؤنيك أإلع  ـريك ⌉*╎
