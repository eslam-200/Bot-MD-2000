...
╯───────────────────⟢ـ
> © ESCONAR ELFAGER 2025`,subtitle: "Araab Zack",},header: { hasMediaAttachment: true,...(await prepareWAMessageMedia({ image : { url: zack } }, { upload: conn.waUploadToServer }, {quoted: m}))},
                    contextInfo: {
                        ...
                        isForwarded: false,
...

                            {
                                ...
                                buttonParamsJson: JSON.stringify({
                                    ...
                                    sections: [
                                        {
                                            title:  مــرحـ🛡ـبــا بــك فـي مــ☑هــام اسـكـونـر بـ🤖ـوت ,
                  ...
                  messageParamsJson:   
                     ...
                     {
               name: "cta_url",
               buttonParamsJson:  {"display_text":"⌈📲╎رقم المطور🥰╎📲⌋","url":"https:https://wa.me/+201098829097"} 
                            }
                        ]
                    }
                }
